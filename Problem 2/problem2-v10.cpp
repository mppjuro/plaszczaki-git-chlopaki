...
// polecenie budowania: g++ -O3 -std=c++17 -o "%e" "%f" huffman.cpp
#include "huffman.h"
#include <iostream>
#include <fstream>
#include <string>
...
#define dict_file "../files/dict.txt"
#define flawed_text "../files/tekstzpoli.txt"
#define flawless_text "../files/tekstbezpoli.txt"
#define huff_bin "../files/huffman.bin"
#define output_txt "../files/out.txt"
#define coded_txt "../files/kodowany.txt"
#define bin_out "../files/output.bin"
#define txt2 "../files/text2.txt"
#define coded_out_txt "../files/kodowanyout.txt"
#define out_comp_bin "../files/outputkomp.bin"
#define coded_cmp2 "../files/kodowanykomp2.txt"
#define txt3 "../files/text3.txt"
#define output_2 "../files/out2.txt"
using namespace std;
int iloscZamian = 0;
class Node{
public:
