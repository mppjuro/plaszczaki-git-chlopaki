...
#define pts "../files/pts.txt"
#define rds_file "../files/roads.txt"
#define hull_file "../files/hull.txt"
#define prt_file "../files/porters.txt"
#define res_file "../files/result.txt"
#define cost_file "../files/koszt.txt"
#define pairs_file "../files/pary_tragarzy.txt"
using namespace std;
...
int main(int argc, char * argv[]){
	...
	TTF_Font * font = TTF_OpenFont("LiberationSans-Regular.ttf", 12);		//Ustawiamy fonty dla SDL	
  	if(!font){
